    ...
    if($result->num_rows==0)
{
  ...
  <td><?php echo $row['status'];?></td>
      <td id="edit" ><a data-id="<?php echo $row['internship_id'];?>" data-name="<?php echo $row['internship_name'];?>"
									href="/employer/internship/add_internship.php?view=edit&internship_id=<?php echo $row['internship_id']; ?>" class="glyphicon glyphicon-edit"
									></a></td>
	...
	require_once($path ."/common/db.php");
  	...
  	?>
  	  		 ...
  	  		 <script type="text/javascript">
  	  	  	...
  	  	  	window.top.location.href="/employer/internship/update_or_delete_internship.php?result_msg=<?php echo $result_msg; ?>";
  	  		 </script>
  	  		<?php 
  }
