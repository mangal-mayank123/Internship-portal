...
//For header
require  $path ."/common/header3.php"; ?>
<?php 
if(isset($_GET['view']))
{
	$view=$_GET['view'];
...
if(isset($_POST['submitInternship']))
{
	...
	$result = $conn->query($query);
		if($result){
			...
			require_once($path ."/employer/internship/class.phpmailer.php");
			...
			try {
				...
				$mail->Username   = "dbtektons"; 
				$mail->Password   = "dbtektons@25";           
				 
				 
				$mail->AddAddress($mailto, '');
				$mail->SetFrom('manisoni28@gmail', 'DB Tektons');
...
$(function(){
    ...
    $( "#cancelInternship" ).click(function() {
        	window.top.location.href="/employer/internship/update_or_delete_internship.php";
    	});
})
