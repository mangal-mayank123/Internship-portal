						...
						<div class="col-md-8 col-md-offset-2 text-center">
							...
							<h4>
								...
								<a href="#" class="btn btn-info btn-lg hp-href"
									...
									<a href="<?php $home_path ?>/student/internshiplist/viewinternwithoutlogin.php" class="btn btn-info btn-lg hp-href"
									>Internships</a>
							</h4>
							<?php 
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="images/homepage/intern.jpg" alt="Chania">
						...
						<div class="item">
							<img src="images/homepage/success.jpg" alt="Chania">
							<div class="carousel-caption all-font">
								<h3>Reliability</h3>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="jumbotron bc-color bc-font-color">
					<div class="col-md-6  bc-font-color text-left">
						</div>
